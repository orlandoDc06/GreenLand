...
<!-- <div class="modal fade" id="cotizarLoteModal" tabindex="-1" aria-labelledby="cotizarLoteModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content shadow-lg rounded-4">
      <div class="modal-header text-white rounded-top-4 px-4 py-3">
        <h5 class="modal-title" id="cotizarLoteModalLabel">Información del Lote</h5>
      ...
      <div class="modal-body px-4 py-4">
        <div class="container-fluid">
          <div class="row mb-3">
            <div class="col-sm-4 fw-semibold text-secondary">Código del Lote:</div>
            <div class="col-sm-8" id="modal-lote-name">-</div>
          </div>
          <div class="row mb-3">
            <div class="col-sm-4 fw-semibold text-secondary">Precio del Lote:</div>
            <div class="col-sm-8" id="modal-lote-precio">-</div>
          </div>
          <div class="row mb-3">
            <div class="col-sm-4 fw-semibold text-secondary">Precio al Contado:</div>
            <div class="col-sm-8" id="modal-lote-precio-contado">-</div>
          </div>
          <div class="row mb-3">
            <div class="col-sm-4 fw-semibold text-secondary">Años de Financiamiento:</div>
            <div class="col-sm-8" id="modal-lote-anos-financiamiento">-</div>
          </div>
          <div class="row mb-3">
          ...
          <div class="row mb-1">
            <div class="col-sm-4 fw-semibold text-secondary">Estado:</div>
            <div class="col-sm-8" id="modal-lote-estado">-</div>
          </div>
        </div>
      </div>
    ...
    <div class="modal-content shadow-lg rounded-4">
      ...
      <div class="modal-body px-4 py-4 text-center">
        ...
        <div class="container text-start">
          ...
          <div class="row mb-3">
            <div class="col-sm-4 fw-semibold text-secondary">Superficie (v²):</div>
            <div class="col-sm-8" id="modal-lote-superficie-vara">-</div>
          </div>
          <div class="row mb-3">
            <div class="col-sm-4 fw-semibold text-secondary">Superficie (m²):</div>
            <div class="col-sm-8" id="modal-lote-superficie-metro">-</div>
          </div>
          <div class="row mb-3">
            <div class="col-sm-4 fw-semibold text-secondary">Dirección:</div>
            <div class="col-sm-8" id="modal-lote-direccion">-</div>
